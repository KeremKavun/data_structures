...
/**
 * @file vstack.h
 * @brief Defines the interface for Vector Stack.
 */

/**
 * @defgroup VSTACK Vector Stack.
 * @ingroup STACK
 * @brief Implementation using a contiguous buffer. Best for cache locality and random access.
 * 
 * @details
 * ### Global Constraints
...
/**
 * @struct vstack
 * @brief Stack ADT based on a dynamic array.
 * @details **Ownership**: Internal slots are owned by the underlying `dynarray` 
 * and managed via `object_concept` for in-place construction. .init method of
 * the object_concept should never be NULL.
 */
struct vstack;
