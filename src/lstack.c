...
int lpush(struct lstack* ls, const void* new_item, size_t obj_size)
{
...
void* lstack_peek(const struct lstack* ls)
{
...
{
    dbly_list_free(&ls->contents, userdata, (deallocator) ? deallocator : default_deallocator);
}
